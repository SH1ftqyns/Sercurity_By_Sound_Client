...
public class Buffer {
    ...
    public Buffer(int bufferCount, int bufferSize) {
        ...
        try {
            for (int i = 0; i < mBufferCount; ++i) {
                mProducerQueue.put(new BufferData(mBufferSize)); // �������������ݽ������  
            }
    ...
    public void reset() {
        ...
        for (int i = 0; i < size; ++i) {
            BufferData data = mProducerQueue.peek(); //Ū����λBufferData
            if (null == data || null == data.mData) {
                mProducerQueue.poll(); //ȥ��������λ
            }
        }

        size = mConsumeQueue.size();  //�õ����е�ǰ��С
        for (int i = 0; i < size; ++i) {
